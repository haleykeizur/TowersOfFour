...
public class TowersOfFour {
     ...
     */
    public TowersOfFour(int ballspertube, int numoftubes,int tubesfill){
    ...
    public static void main(String[] args){
        /*
        The main method is intended to take user input, check for error handling,
        ...
        int ballspertube=0;
        int tubesfilled=0;
        System.out.println("Enter the number of tubes (3-12), number of balls per tube (4-8), and number of tubes filled separated by a space:");
        String in=input.nextLine();
        String arr[]=in.split(" ");
        if(arr.length<3){
            System.out.println("The program needs 3 inputs, program will exit.");
            System.exit(1);
        }
        try {
            ...
            while(numoftubes<4||numoftubes>12){
                System.out.println(numoftubes+" number of tubes is not a valid input, please enter a value between 4 and 12:");
                numoftubes=input.nextInt();
            }
            while(ballspertube<4||ballspertube>8){
                System.out.println(ballspertube+" balls per tube is not a valid input, please enter a value between 4 and 8:");
                ballspertube=input.nextInt();
            }
            while(tubesfilled<2||tubesfilled>numoftubes-2){
                System.out.println(tubesfilled+" tubes filled is not a valid input, please enter a value between 2 and number of tubes - 2:");
        ...
        TowersOfFour tower=new TowersOfFour(ballspertube,numoftubes,tubesfilled);
        tower.fillMatrix();
        System.out.println("Starting Tubes:");
        tower.printMatrix();
        System.out.println();
        tower.solveMatrix();
        System.out.println("Final Tubes: ");
        tower.printMatrix();
    }
}